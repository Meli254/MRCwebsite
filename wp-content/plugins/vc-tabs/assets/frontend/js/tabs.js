        ...
        function OxiTabsController(p = '', c = '') {
            ...
            if (c === '') {
                if (window.matchMedia('screen and (max-width: 993px)').matches) {
                    ...
                    var t = $(title + j.initial).attr('ref'),
                        explode = t.split("-"),
                        parent = explode[3],
                        child = explode[4];
                    ...
                    if (j.trigger === '1' && j.type !== 'oxi-tabs-hover-event') {
                        ...
                        if (window.matchMedia('screen and (max-width: 993px)').matches) {
                            ...
                            var childid = parseInt(child, 10),
                                current = $('.oxi-tabs-ultimate-header-desktop.oxi-tabs-ultimate-header-' + parent + ' .oxi-tabs-header-li-' + parent + '-' + child).eq(0).nextAll().length;
